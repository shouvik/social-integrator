...
export class MetricsCollector {
  ...
  private initializeMetrics(): void {
    ...
    this.histograms.set('http_request_duration', new Histogram({
    ...
    this.counters.set('http_cache_hits', new Counter({
    ...
    this.counters.set('http_errors', new Counter({
    ...
    this.gauges.set('rate_limit_queue_size', new Gauge({
    ...
    this.counters.set('rate_limit_hits', new Counter({
    ...
    // Token metrics (v1.1)
    this.counters.set('token_refresh_total', new Counter({
    ...
    this.counters.set('token_refresh_dedup_local', new Counter({
    ...
    this.counters.set('token_refresh_dedup_distributed', new Counter({
    ...
    this.histograms.set('token_refresh_duration', new Histogram({
    ...
    this.counters.set('token_refresh_failures', new Counter({
    ...
    this.counters.set('connections_total', new Counter({
    ...
    this.histograms.set('fetch_duration', new Histogram({
    ...
    this.gauges.set('items_fetched', new Gauge({
      name: 'items_fetched',
